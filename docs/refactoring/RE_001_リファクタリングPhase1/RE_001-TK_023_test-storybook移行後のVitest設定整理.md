# P2-RE_001-TK_023 `test-storybook` 移行後の Vitest（storybook project）設定整理
...
- 元チケット: [RE_001-TK_003 CI に typecheck + test-storybook を追加](RE_001-TK_003_CIにtypecheckとtest-storybook追加.md)
